...
- **Frameworks:** 🛠️ Frappe
- **Banco de Dados:** 🗃️ MariaDB
- **Front-end:** 🎨 HTML, CSS
- **Outros:** 🌐 Redes de Computadores (em estudo), 🇬🇧 Inglês

## 🚀 Projetos em Destaque
No momento, estou em fase de aprendizado e construção de projetos pessoais para aplicar meus conhecimentos. Em breve, compartilharei aqui meus trabalhos mais relevantes!
